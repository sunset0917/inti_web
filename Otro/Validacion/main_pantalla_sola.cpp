...
void loop() {
  ...
  if (nuevoDatoRecibido) {
	...
	Serial.printf("Render total OLED: %lu us\n", t_finRender - t_inicioRender);
	Serial.printf("Desde dato recibido hasta visible: %lu us\n", t_finRender - t_llegaDato);
	Serial.println("-------------------");
